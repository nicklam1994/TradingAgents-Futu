"""AiTick Market Data Provider — HK/US equities via AiTick API.

Requires AITICK_API_KEY environment variable.
...
class AiTickProvider(BaseMarketDataProvider):
    """AiTick data provider for HK/US equities."""
    ...
    def _not_implemented(self, method: str) -> str:
        raise NotImplementedError(
            f"Provider 'aitick' is a placeholder. {method} not yet implemented."
        )

    def _api_key(self) -> str | None:
        return os.getenv("AITICK_API_KEY")
