"""iTick Market Data Provider — HK/US equities via iTick API.

Requires ITICK_API_KEY environment variable.
...
class ITickProvider(BaseMarketDataProvider):
    """iTick data provider for HK/US equities."""
    ...
    def _not_implemented(self, method: str) -> str:
        raise NotImplementedError(
            f"Provider 'itick' is a placeholder. {method} not yet implemented."
        )
