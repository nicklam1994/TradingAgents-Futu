"""Finnhub Market Data Provider — US equities via Finnhub.io API.
...
class FinnhubProvider(BaseMarketDataProvider):
    """Finnhub.io data provider for US equities."""
    ...
    def _not_implemented(self, method: str) -> str:
        raise NotImplementedError(
            f"Provider 'finnhub' is a placeholder. {method} not yet implemented."
        )
