"""Shadow Account data models for TradingAgents-Futu.

Adapted from Vibe-Trading agent/src/shadow_account/models.py.
Simplified for TAF's HK/US stock/ETF focus.

Phase 13.2: Shadow Account — 交易行为诊断
"""
...
class ShadowRule:
    ...
    Attributes:
        ...
        entry_condition: Structured condition dict for signal matching.
        ...
        sample_trades: Representative trade examples.
...
class ShadowProfile:
    ...
    Attributes:
        ...
        journal_hash: SHA1 of source data for idempotency.
        source_market: Primary market ("HK" or "US").
        profitable_roundtrips: Number of profitable roundtrips used.
        total_roundtrips: Total roundtrips in journal.
        date_range: (start_iso, end_iso) of the journal.
        profile_text: One-paragraph Chinese portrait.
        rules: Tuple of 3-5 ShadowRule.
        preferred_markets: Markets the user actually traded.
...
class AttributionBreakdown:
    ...
    All PnL fields are in the journal's account currency (HKD/USD).
    """
